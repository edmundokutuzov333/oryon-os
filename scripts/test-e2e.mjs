...
if (!base || !org || !key) { console.log("Phase 15 E2E: environment not configured, structural gate remains active."); process.exit(0); }
...
if (![200, 403].includes(audit.status)) throw new Error(`audit endpoint unexpected status: ${audit.status}`);
