...
export default async function OryonLayout({ children }: { children: React.ReactNode }) {
  ...
  return <OryonAppShell userName={userName} userInitials={userInitials}>{children}</OryonAppShell>;
}
