...
export const RsvpStateSchema = z.enum([
	"PENDING",
	"ACCEPTED",
	"DECLINED",
	"TENTATIVE",
...
export const MeetingStateInputSchema = z.object({
	state: z.enum(["LIVE", "ENDED", "CANCELLED"]),
});
...
export type MeetingParticipantCreateInput = z.infer<
	typeof MeetingParticipantCreateInputSchema
>;
export type MeetingParticipantUpdateInput = z.infer<
	typeof MeetingParticipantUpdateInputSchema
>;
export type MeetingStateInput = z.infer<typeof MeetingStateInputSchema>;
export type MeetingArtifactCreateInput = z.infer<
	typeof MeetingArtifactCreateInputSchema
>;
export type MeetingArtifactConvertInput = z.infer<
	typeof MeetingArtifactConvertInputSchema
>;
