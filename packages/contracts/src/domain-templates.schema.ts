...
import {
	ObjectFieldDefSchema,
	ObjectStatusModelSchema,
} from "./work-object.schema.js";
...
export const DomainTemplateStatusSchema = z.enum([
	"AVAILABLE",
	"INSTALLED",
	"INACTIVE",
]);
...
export type DomainTemplateManifest = z.infer<
	typeof DomainTemplateManifestSchema
>;
export type DomainTemplateSummary = z.infer<typeof DomainTemplateSummarySchema>;
export type DomainTemplateInstallResponse = z.infer<
	typeof DomainTemplateInstallResponseSchema
>;
