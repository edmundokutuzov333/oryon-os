...
export const PageSchema = z.object({
	...
	contentYjsBase64: z.string().base64().nullable(),
	...
	reviewEveryDays: z.number().int().positive().nullable(),
...
export const PageUpdateInputSchema = z.object({
	...
	contentText: z.string().max(500000).nullable().optional(),
	contentYjsBase64: z.string().base64().nullable().optional(),
	classification: z.string().min(1).nullable().optional(),
	reviewEveryDays: z.number().int().positive().max(3650).nullable().optional(),
...
export const FileUploadIntentInputSchema = z.object({
	...
	sizeBytes: z.number().int().positive().max(536870912),
	checksumSha256: z.string().regex(/^[a-f0-9]{64}$/),
});
export const FileUploadIntentSchema = z.object({
	uploadId: z.string(),
	fileId: z.string(),
	storageKey: z.string(),
...
export const FileCompleteInputSchema = z.object({
