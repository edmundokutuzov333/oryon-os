...
export const PermissionSubjectSchema = z.object({ id: z.string().min(1), type: z.enum(["MEMBER", "GUEST", "CLIENT", "VENDOR", "AGENT", "SERVICE_ACCOUNT"]), email: z.string().email(), teamIds: z.array(z.string().min(1)).default([]), channelIds: z.array(z.string().min(1)).default([]) });
...
export type PermissionExposureReport = z.infer<typeof PermissionExposureReportSchema>;
