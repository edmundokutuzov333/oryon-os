...
export const PermissionSubjectSchema = z.object({ id: z.string().min(1), type: z.enum(["MEMBER", "GUEST", "CLIENT", "VENDOR", "AGENT", "SERVICE_ACCOUNT"]), email: z.string().email(), teamIds: z.array(z.string().min(1)).default([]), channelIds: z.array(z.string().min(1)).default([]), meetingIds: z.array(z.string().min(1)).default([]) });
export const PermissionResourceSchema = z.object({ orgId: z.string().min(1), type: z.string().min(1), id: z.string().min(1), workspaceId: z.string().min(1).nullable().default(null), projectId: z.string().min(1).nullable().default(null), ownerId: z.string().min(1).nullable().default(null), teamId: z.string().min(1).nullable().default(null), classification: z.string().min(1).nullable().default(null) });
...
export const PermissionExposureReportSchema = z.object({ generatedAt: z.string().datetime({ offset: true }), organizationId: z.string().min(1), resources: z.array(z.object({ resourceType: z.string().min(1), resourceId: z.string().min(1), externalPrincipals: z.number().int().nonnegative(), aiAllowed: z.boolean(), externalAllowed: z.boolean(), fieldMasked: z.boolean(), watermark: z.boolean(), expiresAt: z.string().datetime({ offset: true }).nullable() })) });
export const PermissionRoleCreateInputSchema = z.object({ key: z.string().min(1), name: z.string().min(1), description: z.string().optional(), permissions: z.array(z.string().min(1)) });
export const PermissionRoleBindingCreateInputSchema = z.object({ roleId: z.string().min(1), principalId: z.string().min(1), scopeType: PermissionScopeSchema, scopeId: z.string().min(1).nullable().optional(), expiresAt: z.string().datetime({ offset: true }).nullable().optional() });
export const PermissionGrantCreateInputSchema = z.object({ resourceType: z.string().min(1), resourceId: z.string().min(1), principalId: z.string().min(1).nullable().optional(), teamId: z.string().min(1).nullable().optional(), externalEmail: z.string().email().nullable().optional(), level: PermissionLevelSchema, fieldMask: z.array(z.string().min(1)), reason: z.string().optional(), expiresAt: z.string().datetime({ offset: true }).nullable().optional() });
