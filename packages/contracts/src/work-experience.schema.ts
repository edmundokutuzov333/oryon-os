...
export const WorkObjectHistoryResponseSchema = z.array(
	WorkObjectHistoryEventSchema,
);

export type WorkObjectComment = z.infer<typeof WorkObjectCommentSchema>;
export type WorkObjectCommentCreateInput = z.infer<
	typeof WorkObjectCommentCreateInputSchema
>;
export type WorkObjectAttachment = z.infer<typeof WorkObjectAttachmentSchema>;
export type WorkObjectAttachmentCreateInput = z.infer<
	typeof WorkObjectAttachmentCreateInputSchema
>;
export type WorkObjectHistoryEvent = z.infer<
	typeof WorkObjectHistoryEventSchema
>;
